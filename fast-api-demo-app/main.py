...
uri = "mongodb+srv://snglayush:ayUsh12345@cluster0.1hvi32m.mongodb.net/?retryWrites=true&w=majority"
...
async def read_item(month: int, year:int, userToken: str | None = None):
    ...
    myclient = pymongo.MongoClient("mongodb+srv://snglayush:ayUsh12345@cluster0.1hvi32m.mongodb.net/?retryWrites=true&w=majority")
